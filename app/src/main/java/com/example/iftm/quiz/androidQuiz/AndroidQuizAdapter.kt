...
class AndroidQuizAdapter(
    private val courseList: ArrayList<AndroidQuizModel>,
    private val context: Context?=null
): RecyclerView.Adapter<AndroidQuizAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val basicComputerQuizModel: AndroidQuizModel = courseList[position]
