package com.example.iftm.news.data
...
//            News(R.string.news6, R.string.url6, R.string.description6, R.string.src6),
//            News(R.string.news7, R.string.url7, R.string.description7, R.string.src7),
//            News(R.string.news8, R.string.url8, R.string.description8, R.string.src8),
//
//        )
//    }
}